...
<div className="bg-gray-600 w-[80%] h-fit rounded-md mt-28">
       ...
       <MusicNowPlaying artiste={audio?.data.artiste} title={audio?.data.title} audio = {isLoading ? null : audio?.data.audioUrl} text={`https://supervibesrecords.com/discography/audio/${params.audio}`}></MusicNowPlaying>
</>
)
:
 (<>
