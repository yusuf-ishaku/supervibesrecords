...
export default async function Page({params}) {
  ...
  return (
    ...
    {<MusicNowPlaying artiste={audio?.data.artiste} title={audio?.data.title} audio = {audio?.data.audioUrl} text={`https://supervibesrecords.com/discography/audio/${params.audio}`}></MusicNowPlaying>} 
    </section>
  )
}